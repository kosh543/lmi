...
check_concinnity: source_clean custom_tools
	...
	@significant_files=$$(find . -type f | sed 's@^./@@' | grep --extended-regexp --invert-match '^\.|^COPYING$$|^quoted_gpl|^ChangeLog-|Log$$|^Speed_|(^|\.)md5sums$$|\.(ico|ini|png|xpm|txt|patch|touchstone|cns|ill|gpt|mec|inix)$$|^INSTALL$$|^README'); \
