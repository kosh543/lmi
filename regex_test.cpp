...
///
/// In C++11, the behaviour of each of the metacharacters is fixed and can only
/// be changed by switching to a non-default regex syntax. The tests here
/// compare performance of matching using different syntaxes.
